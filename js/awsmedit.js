function rcEdit(currEditor, defaults, id) {
  ...
  function initDrag(e) {
     ...
     // startHeight = parseInt(document.defaultView.getComputedStyle(resizr).height, 10);
     document.documentElement.addEventListener('mousemove', doDrag, false);
     document.documentElement.addEventListener('mouseup', stopDrag, false);
  }

  function doDrag(e) {
      // set style width to original width +
     resizr.style.width = (startWidth + e.clientX - startX) + 'px';
     // resizr.style.height = (startHeight + e.clientY - startY) + 'px';
  }
  ...
  resizzr.mouseover(function() {
    var self = $(this),
        resizer = self.find('.resizer');
    console.log('hi');
  ...
  //     resizr.className = resizr.className + ' resizable';
  //     var resizer = document.createElement('div');
  //     resizer.className = 'resizer';
  //     resizr.appendChild(resizer);
